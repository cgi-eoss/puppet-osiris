class osiris::monitor::graylog_collector (
  ...
  $real_graylog_server = pick($graylog_server, $osiris::globals::monitor_hostname)
  $real_graylog_gelf_tcp_port = pick($graylog_gelf_tcp_port, $osiris::globals::graylog_gelf_tcp_port)
  ...
  file { $config_file:
    ...
    mode    => '640',
    content => epp('osiris/graylog-collector/collector.conf.epp', {
