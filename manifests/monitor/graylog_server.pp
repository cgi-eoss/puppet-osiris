class osiris::monitor::graylog_server (
  $db_secret    = undef,
  $db_sha256    = undef,
  ...
  $real_db_secret = pick($db_secret, $osiris::globals::graylog_secret)
  $real_db_sha256 = pick($db_sha256, $osiris::globals::graylog_sha256)
  $real_listen_port = pick($listen_port, $osiris::globals::graylog_port)
  $real_context_path = pick($context_path, $osiris::globals::graylog_context_path)
